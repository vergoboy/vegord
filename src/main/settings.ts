...
import { type Settings as TvegordSettings } from "@vencord/types/Vencord";
import { mkdirSync, readFileSync, writeFileSync } from "fs";
import { dirname, join } from "path";
import type { Settings as TSettings, State as TState } from "shared/settings";
import { SettingsStore } from "shared/utils/SettingsStore";

import { DATA_DIR, VEGORD_SETTINGS_FILE } from "./constants";
...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "vegord settings");
export const vegordSettings = loadSettings<TvegordSettings>(VEGORD_SETTINGS_FILE, "vegord settings");
export const State = loadSettings<TState>(STATE_FILE, "vegord state");
